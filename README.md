...
- **CI/CD** — Jenkins, GitHub Actions, ArgoCD · scalable pipelines for safety-critical automotive software
- **Containers** — Docker, Docker Compose, Kubernetes, Helm, Portainer
...
|---|---|
| 💰 Actual Budget | Privacy-first personal finance *(my favourite)* |
